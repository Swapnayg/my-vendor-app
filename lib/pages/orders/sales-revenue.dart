...
class _SalesRevenuePageState extends State<SalesRevenuePage> {
  ...
  // Mock data for ordered, cancelled, returned, delivered
  final List<Map<String, dynamic>> salesData = List.generate(7, (index) {
    return {
      'date': DateTime.now().subtract(Duration(days: 6 - index)),
      'ordered': (index + 1) * 1200,
      'cancelled': (index + 1) * 300,
      'returned': (index + 1) * 150,
      'delivered': (index + 1) * 1000,
    };
  });
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Legend below cards, right aligned
            Row(
                ...
                BarChartData(
                      ...
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, meta) {
                          ...
                          if (index < salesData.length) {
                            final date = salesData[index]['date'] as DateTime;
                            return Text(
                  ...
                  barGroups: List.generate(salesData.length, (index) {
                    ...
                    return BarChartGroupData(
                      ...
                      barRods: [
                        BarChartRodData(
                          toY: day['ordered'].toDouble(),
                          color: Colors.blue,
                          width: 8,
                        ),
                        BarChartRodData(
                          toY: day['cancelled'].toDouble(),
                          color: Colors.orange,
                          width: 8,
                        ),
                        BarChartRodData(
                          toY: day['returned'].toDouble(),
                          color: Colors.red,
                          width: 8,
                        ),
                        BarChartRodData(
                          toY: day['delivered'].toDouble(),
                          color: Colors.green,
                          width: 8,
                        ),
                      ],
